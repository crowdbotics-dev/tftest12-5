"""
Django settings for tftest12_5 project.
...
WSGI_APPLICATION = 'tftest12_5.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tftest12_5 API",
    "DESCRIPTION": "API documentation for tftest12_5 App",
    "VERSION": "v1",
}
